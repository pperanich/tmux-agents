...
/// broker-time verdict and so is not part of [`RefusalReason`], plus the `text` payload rules,
/// which refuse earlier than either.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Refusal {
...
impl ActResult {
    ...
    pub const fn exit_code(&self) -> i32 {
        match &self.outcome {
            ...
            Outcome::Refused(Refusal::Gate(_) | Refusal::Payload(_)) => 4,
    ...
    pub const fn severity(&self) -> u8 {
        match &self.outcome {
            ...
            Outcome::Refused(Refusal::Gate(_) | Refusal::Payload(_)) => 2,
            Outcome::Vanished(_) => 3,
            Outcome::Timeout => 4,
            Outcome::Exited(_) => 5,
            Outcome::Error(_) => 6,
